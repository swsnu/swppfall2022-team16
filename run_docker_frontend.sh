...
ENCRYPT_SSL_FULLCHAIN_PATH="/etc/letsencrypt/archive/bridgeus.shop/fullchain1.pem"
ENCRYPT_SSL_PRIVKEY_PATH="/etc/letsencrypt/archive/bridgeus.shop/privkey1.pem"
